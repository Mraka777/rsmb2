...
<table>
  <tr>
    ...
    <tr>
      <td>rating_str</td><td width=250>
      							<?php
                    //$rating[0]['rating_str'] = $rating[0]['rating_str']/10;
                    print("<br><div class=\"progress\">
											<div class=\"progress-bar\" role=\"progressbar\" aria-valuenow=\"".$rating[0]['rating_str']."\" aria-valuemin=\"0\" aria-valuemax=\"1000\" style=\"width: ".($rating[0]['rating_str']/10)."%;\">
												".$rating[0]['rating_str']."
											</div>
										</div>"); ?>
