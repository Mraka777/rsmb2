...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="http://www.biathlon-manager.com/css/bootstrap.min.css" rel="stylesheet">
 ...
 <script src="http://www.biathlon-manager.com/js/bootstrap.min.js"></script>
...
<table align=center width=800>
	...
	<tr>
		<td>
			<p class="bg-danger" align="center"><b>ATTENTION! ALPHA-TEST STAGE WITH BUGS AND UPDATES ON AIR.</b></p>
		</td>
	</tr>
	<tr>
	<td>
    <div> <!-- Only required for left/right tabs -->
      <ul class="nav nav-tabs">
        ...
        <li><a href="#tab2" data-toggle="tab"><?php echo($general[1]['rsm_type_text']);?></a></li>
				...
				<li><a href="#tab6" data-toggle="tab"><?php echo($general[5]['rsm_type_text']);?></a></li>
      </ul>
