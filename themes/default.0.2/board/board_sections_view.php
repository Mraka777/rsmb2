   ...
   <div class="container theme-showcase">
				...
				<div class="row clearfix content-main">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading"><strong><a href="/<?php echo($rsm_base_url);?>/board/">Forum</a> -> </strong></div>
						<div class="panel-body">					
							<?php
							//print_r($rsm_base_url."<br>");
								foreach ($board_sections as $sections) {
									print ("<a href=\"/");print($rsm_base_url);print("/board/section/".$sections['rsm_board_section_id']."\">".$sections['rsm_board_section_name']."</a>");
								}
