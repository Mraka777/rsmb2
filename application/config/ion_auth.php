 ...
 */
$config['site_title']                 = "Biathlon manager";       // Site Title, example.com
$config['admin_email']                = "admin@biathlon-manager.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Players';           // Default group, use name
...
$config['track_login_attempts']       = FALSE;               //ÃËÞ×ÈÒ?// Track the number of failed login attempts for each user or ip.
